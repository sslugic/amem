...
<!-- Generated by amem for: OpenAI Codex, Grok, OpenCode, Crush, Amp, Qwen Code, Factory Droid, OpenHands, Warp, Zed, Sourcegraph Cody, Antigravity, Neovim, Claude Desktop, Devin, Jules. Safe to commit: guidance only, no memory contents. -->
